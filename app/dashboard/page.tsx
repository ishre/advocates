          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-2xl font-bold text-gray-900">Legal Case Manager</h1>
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  ...
                  {/* System Status */}
                  <DropdownMenuLabel className="text-xs font-semibold text-gray-500">System Status</DropdownMenuLabel>
                  <DropdownMenuItem disabled className="text-xs">
                    <div className="flex items-center justify-between w-full">
                      <span>MongoDB</span>
                      <span className={systemStatus.mongodb ? 'text-green-600' : 'text-red-600'}>
                  ...
                  <DropdownMenuItem disabled className="text-xs">
                    <div className="flex items-center justify-between w-full">
                      ...
                      <span className={systemStatus.googleDrive ? 'text-green-600' : 'text-yellow-600'}>
                  ...
                  <DropdownMenuItem disabled className="text-xs">
                    <div className="flex items-center justify-between w-full">
                      ...
                      <span className={systemStatus.emailService ? 'text-green-600' : 'text-yellow-600'}>
                  ...
                  {/* Backup Actions */}
                  <DropdownMenuLabel className="text-xs font-semibold text-gray-500">Backup & Data</DropdownMenuLabel>
                  <DropdownMenuItem onClick={handleCreateSampleData} disabled={sampleDataStatus === 'creating'}>
                    <Database className="mr-2 h-4 w-4" />
                    <span>Create Sample Data</span>
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={handleBackup} disabled={backupStatus === 'backing_up'}>
                    <Upload className="mr-2 h-4 w-4" />
                    <span>{backupStatus === 'backing_up' ? 'Creating Backup...' : 'Create Backup'}</span>
                  </DropdownMenuItem>
                  ...
                  {availableBackups.length > 0 && (
                    <>
                      <DropdownMenuSeparator />
                      <DropdownMenuLabel className="text-xs font-semibold text-gray-500">Restore Options</DropdownMenuLabel>
                      <DropdownMenuItem disabled className="text-xs">
                        <div className="flex items-center justify-between w-full">
                          <span>Available Backups</span>
                          <span className="text-blue-600">{availableBackups.length}</span>
                        </div>
                      </DropdownMenuItem>
                  ...
                  {/* Quick Actions */}
                  <DropdownMenuLabel className="text-xs font-semibold text-gray-500">Quick Actions</DropdownMenuLabel>
                  <DropdownMenuItem onClick={handleNewCase}>
                  ...
                  <DropdownMenuItem onClick={handleScheduleHearing}>
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => fetchDashboardData()}>
